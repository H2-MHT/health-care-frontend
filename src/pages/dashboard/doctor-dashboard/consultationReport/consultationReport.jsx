...
function ConsultationReport() {
  ...
  const consultationList = async () => {
    try {
      const response =
        await fetchData(`consultation/consultation-report/?appointment_id=${parseInt(id)}`,
        navigate);
      if (!response.ok) {
            ...
            <div class="left bg-white-transparent padding-20">
              <div class="reportContent border-radius-20 border-gray padding-20">
                ...
                <p>
                  ...
                  nec quis Nam non in lacus, id ultrices ex. at elit at, maximus
                  non ex porta ullamcorper Nunc tortor. faucibus non, Quisque id
                  leo. varius Nullam vehicula, vitae diam varius nisl.{" "}
                </p>
                <p>
                  faucibus non, Quisque id viverra nibh Praesent Quisque
                  placerat placerat cursus non amet, adipiscing elit. urna nisl.
                  viverra enim. elementum ac nec{" "}
                </p>
                <p>
                  ...
                  enim. elementum ac nec quis Nam non in lacus, id ultrices ex.
                  at elit at, maximus non ex porta ullamcorper Nunc tortor.
                  faucibus non, Quisque id viverra nibh Praesent Quisque
                  placerat placerat cursus non amet, adipiscing elit. urna nisl.
                  viverra enim. elementum ac nec{" "}
                </p>
