...
const CommunicationNotifications = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const isUnchanged = Object.values(formData).every(value => !value);
  
    if (isUnchanged) {
      showToast("Please select at least one preference before saving.", "error");
      return;
    }
    ...
    try {
      ...
      if (response?.status === 200) {
        ...
        showToast(responseData?.message || "Preferences updated successfully!", "success");
      } else {
