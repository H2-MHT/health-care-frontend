      ...
      <div class="publicViewMain bg-white border-radius-20">
        ...
        <div class="doc_public_view ">
          <div class="docDetails">
                ...
                <div class="clinic_headPublic d-flex justify-content-between gap-2">
                  <div class="loc d-flex gap-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      ...
                      <span class="text-green">City, Street N</span>
                    </div>
                  </div>
            ...
            <div class="doctorData">
              <p>
                viverra nibh Praesent Quisque placerat placerat cursus non amet,
                adipiscing elit. urna nisl. viverra enim. elementum ac nec{" "}
              </p>
              <p>
              ...
              <p>
                ...
                sollicitudin. venenatis sollicitudin. at dui. urna. ullamcorper
                urna viverra nibh Praesent Quisque placerat placerat cursus non
                amet, adipiscing elit. urna nisl. viverra enim. elementum ac nec{" "}
              </p>
              <p>
                quis Nam non in lacus, id ultrices ex. at elit at, maximus non
                ex porta ullamcorper Nunc tortor. faucibus non, Quisque id{" "}
            ...
            <div class="tabbing">
              <ul>
                <li>
                  <a href="#">{t("fav-clinic.specialisties")}</a>
                </li>
                <li class="active">
                  <a href="#">{t("drawer.doctors")}</a>
                </li>
                <li>
                  <a href="#">{t("dashboard.reviews")}</a>
                </li>
                <li>
                  <a href="#">{t("edit-profile.media-digest")}</a>
                </li>
                <li>
                  <a href="#">{t("fav-clinic.info")}</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="reviews">
          <div class="tabbing">
            <ul>
              <li>
                <a href="#">{t("fav-clinic.prof-history")}</a>
              </li>
              <li>
                <a href="#">{t("fav-clinic.licenses")}</a>
              </li>
              <li class="active">
                <a href="#">{t("dashboard.reviews")}</a>
              </li>
              ...
              <li>
                <a href="#">{t("fav-clinic.full-schedule")}</a>
              </li>
            </ul>
          </div>
            ...
            <div class="w-100">
                ...
                <div class="item">
                  <div class="recomend">
                    <div class="recomendBox">
                      <div class="d-flex gap-3">
                              ...
                              <div class="top">
                                <div class="verified">
                                  ...
                                  <span class="main-blue-text">
                                    14 {t("fav-clinic.years-practice")}
                                  </span>
                                </div>
                              </div>
                        ...
                        <div class="right">
                          <div class="greenimg">
                            ...
                            <span>{t("fav-clinic.general-medicine")}</span>
                          </div>
                      ...
                      <p>
                        viverra nibh Praesent Quisque placerat placerat cursus
                        non amet, adipviverra nibh Praesent Quisque placerat
                        placerat cursus non amet, adipiscing elit. urna nisl.
                        viverra enim.{" "}
                      </p>
              ...
              <div class="d-flex justify-content-center">
                <a href="#" class="blue_btn d-flex align-items-center gap-3">
                  {t("fav-clinic.meet-our-doctors")}
                  <img src="../images/meetDoc.svg" width={30} />{" "}
                </a>
              </div>
            </div>
          </div>
...
export default ClinicPublicView
